...
typedef void (^SBSDKLicenseFailureHandler)(dooLicenseStatus reason, dooFeature feature, NSString* _Nullable errorMessage);
 ...
 * which usually is your applications bundle.In this case you don't need to call this function.
