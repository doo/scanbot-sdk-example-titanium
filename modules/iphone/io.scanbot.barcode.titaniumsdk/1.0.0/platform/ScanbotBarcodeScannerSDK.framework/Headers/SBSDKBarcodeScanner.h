 ...
 * @param barCodeTypes Bar code types to limit detection results to.
 */
- (nonnull instancetype)initWithFrameAccumulator:(NSInteger)accumulatedFrames
                                           types:(nonnull NSArray<SBSDKBarcodeType *> *)barCodeTypes;
...
@property (nonatomic, assign) NSInteger accumulatedFramesCount;
